...
[_ALPHA0] = MKLAYOUT( \
  ...
  KC_I,                   KC_S,             KC_R,             KC_T,          LGUI(LSFT(KC_4)),          _______,        _______,  _______,      KC_N,         KC_E,        KC_A,        KC_O, \
...
[_GAME1] = MKLAYOUT( \
  ...
  TO(_GAME4), TO(_GAME2), KC_END,  KC_PGDN,       KC_RBRC,    _______, _______, _______, _______, _______, _______, _______, \
  _______,    _______,    _______, OSM(MOD_LSFT), TO(_GAME0), _______,          _______, _______, _______, _______, _______ \
), \
 \
[_GAME2] = MKLAYOUT( \
  ...
  KC_LSFT, OSM(MOD_LCTL), OSM(MOD_LALT), OSM(MOD_LGUI), KC_QUOT,    _______, _______, _______, _______, _______, _______, _______, \
  _______, _______,       _______,       OSM(MOD_LSFT), TO(_GAME0), _______,          _______, _______, _______, _______, _______ \
), \
 \
[_GAME3] = MKLAYOUT( \
 ...
 \
[_GAME4] = MKLAYOUT( \
  KC_F6,   KC_F7,   KC_F8,    KC_F9,         KC_F10,    _______, _______, _______, _______, _______, _______, TO(_ALPHA0), \
  KC_6,    KC_7,    KC_8,     KC_9,          KC_0,      _______, _______, _______, _______, _______, _______, _______, \
  KC_DEL,  KC_MINS, KC_EQL,   _______,       _______,   _______, _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, OSM(MOD_LSFT), TO(_GAME0), _______,          _______, _______, _______, _______, _______ \
), \
 \
[_FKEYS] = MKLAYOUT( \
 ...
 \
[_ARROWS] = MKLAYOUT( \
  _______,       _______,       _______, _______,       _______, _______, _______, _______, KC_X,    KC_C,    KC_V,    KC_Z, \
  _______,       LGUI(KC_LBRC), KC_UP,   LGUI(KC_RBRC), _______, _______, _______, KC_K,    KC_LGUI, KC_LALT, KC_LCTL, KC_D, \
  LSFT(KC_LALT), KC_LEFT,       KC_DOWN, KC_RIGHT,      _______, _______, _______, KC_Q,    KC_A,    KC_S,    KC_F,    KC_LSFT, \
  _______,       _______,       _______, _______,       _______, _______,          _______, _______, _______, _______, _______ \
), \
 \
[_MOUSE] = MKLAYOUT( \
