...
[_GAME0] = LAYOUT(
  ...
  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,           KC_MS_WH_DOWN, KC_MS_WH_LEFT, KC_MS_UP,   KC_MS_WH_RIGHT, _______,
  KC_LSFT, KC_A,    KC_S,    KC_D,    KC_F,           KC_MS_WH_UP,   KC_MS_LEFT,    KC_MS_DOWN, KC_MS_RIGHT,    KC_MS_ACCEL2,
...
[_ARROWS] = LAYOUT(
  ...
  KC_F,    KC_S,    KC_Q,    KC_A,    KC_D,           _______, KC_LEFT, KC_DOWN, KC_UP,    KC_RIGHT,
                                  _______, _______, _______, _______
),
...
[_HJKL] = LAYOUT(
  ...
  _______, _______, LCTL(KC_N), LCTL(KC_F), _______,        _______, KC_H,    KC_J,    KC_K,     KC_L,
                                      _______, _______, _______, _______
),
