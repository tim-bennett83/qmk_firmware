...
[_ALPHA0] = LAYOUT(
  ...
  KC_ENT,  CTL_T(KC_C), OPT_T(KC_L), CMD_T(KC_D), LGUI(LSFT(LCTL(KC_4))),         _______,  CMD_T(KC_J), OPT_T(KC_U), CTL_T(KC_B), KC_BSPC,
  KC_I,    KC_S,        KC_R,        KC_T,        LGUI(LSFT(KC_4)),               KC_CAPS,  KC_N,        KC_E,        KC_A,        KC_O,
